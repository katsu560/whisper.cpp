...
RESULT=0
do_cp CMakeLists.txt	CMakeLists.txt.240629	CMakeLists.txt.240629mod
do_cp Makefile	Makefile.240629	Makefile.240629mod
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240629	examples/CMakeLists.txt.240629mod
do_cp examples/common-ggml.cpp	examples/common-ggml.cpp.240602	examples/common-ggml.cpp.240629mod
do_cp examples/common-ggml.h	examples/common-ggml.h.240225	examples/common-ggml.h.240629mod
do_cp examples/common-sdl.cpp	examples/common-sdl.cpp.240629	examples/common-sdl.cpp.240629mod
do_cp examples/common-sdl.h	examples/common-sdl.h.240225	examples/common-sdl.h.240629mod
do_cp examples/common.cpp	examples/common.cpp.240629	examples/common.cpp.240629mod
do_cp examples/common.h	examples/common.h.240629	examples/common.h.240629mod
do_cp examples/dr_wav.h	examples/dr_wav.h.240225	examples/dr_wav.h.240629mod
do_cp examples/grammar-parser.cpp	examples/grammar-parser.cpp.240629	examples/grammar-parser.cpp.240629mod
do_cp examples/grammar-parser.h	examples/grammar-parser.h.240225	examples/grammar-parser.h.240629mod
do_cp examples/main/CMakeLists.txt	examples/main/CMakeLists.txt.240602	examples/main/CMakeLists.txt.240629mod
do_cp examples/main/main.cpp	examples/main/main.cpp.240629	examples/main/main.cpp.240629mod
do_cp examples/bench/CMakeLists.txt	examples/bench/CMakeLists.txt.240225	examples/bench/CMakeLists.txt.240629mod
do_cp examples/bench/bench.cpp	examples/bench/bench.cpp.240629	examples/bench/bench.cpp.240629mod
do_cp examples/quantize/CMakeLists.txt	examples/quantize/CMakeLists.txt.240225	examples/quantize/CMakeLists.txt.240629mod
do_cp examples/quantize/quantize.cpp	examples/quantize/quantize.cpp.240629	examples/quantize/quantize.cpp.240629mod
do_cp examples/sycl/CMakeLists.txt	examples/sycl/CMakeLists.txt.240225	examples/sycl/CMakeLists.txt.240629mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240602	tests/CMakeLists.txt.240629mod
msg "RESULT: $RESULT"
