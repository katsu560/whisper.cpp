...
usage()
{
	echo "usage: $MYNAME [-h][-v][-n][-nd][-xm][-xd][-a folders,...] zip-filename|commands"
	...
	echo "  -a|--add 240303,240303up ... add specified folders in build folder"
	echo "  chkmodels ... check models"
	echo "  chkdate ... check date folders"
	echo "  zip-filename ... zip filename ex. ${ZIPBASE}-240303up.zip"
}
